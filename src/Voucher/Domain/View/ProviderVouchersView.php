...
/**
 * @implements ArrayableView<array<array{code: string, issuedToEmail: string, claimedByUser: string|null, createdByUser: string}>>
 */
final readonly class ProviderVouchersView implements ArrayableView
{
    ...
    /**
     * @return array<array{code: string, issuedToEmail: string, claimedByUser: string|null, createdByUser: string}>
     */
